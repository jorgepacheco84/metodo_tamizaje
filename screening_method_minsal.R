...
efectividad_semana <- data.frame(semana = rep(c("31", "32", "33"), each = 2),
                                 Desenlace = rep(c("UCI", "Fallecer"), times = 3),
                                 VE = c(VE_uci_31, VE_def_31, VE_uci_32, VE_def_32, VE_uci_33, VE_def_33),
                                 lb = c(VE_uci_31_ic[1], VE_def_31_ic[1], VE_uci_32_ic[1], VE_def_32_ic[1], VE_uci_33_ic[1], VE_def_33_ic[1]),
                                 ub = c(VE_uci_31_ic[2], VE_def_31_ic[2], VE_uci_32_ic[2], VE_def_32_ic[2], VE_uci_33_ic[2], VE_def_33_ic[2]))
