...
efectividad_comparada <- data.frame(Fuente = c("Método de tamizaje (ajustado por edad)", "Coronovac - Ministerio de Salud (Agosto 2021)", "Coronavac - Jara et al, 2021 (ajustado por sexo y edad)"),
